<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="ClientTax.aspx.cs" Inherits="CharteredAccountantsFYP.CA_Admin.ClientTax" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
   ...
   <script>
    ...
    <div class="AdminBackAddEvent">
        <h2 style="text-align:center">Tax Module</h2>
        ...
        <table style="width: 101%">
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp; &nbsp;
                    <asp:FileUpload  ID="FileUpload1" ClientIDMode="Static" CssClass="AllTextBox" onchange="UploadFileNow();" runat="server" Width="30%" />
                    <br />
