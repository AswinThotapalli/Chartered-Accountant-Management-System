<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="DisableUsers.aspx.cs" Inherits="CharteredAccountantsFYP.CA_Admin.DisableUsers" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">

    <div class="AdminBackAddEvent Scroller" >

        <h2 style="text-align:center">Disable Users</h2>
        ...
        <div style="float:left">
            <span style="font-size:15px; line-height: 27px;">Number Of Users</span>
        </div>
