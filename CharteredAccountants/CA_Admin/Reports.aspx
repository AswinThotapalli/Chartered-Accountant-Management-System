<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="Reports.aspx.cs" Inherits="CharteredAccountantsFYP.CA_Admin.Reports" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">

    <div class="AdminBackAddEvent" style="">

        <h2 style="text-align:center">Report Home</h2>
